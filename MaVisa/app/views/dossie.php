...
<body>
    ...
    <main class="dos m-5 p-3 border rounded shadow">
        <form class="row g-3 p-3" id="form" method="POST">
            ...
            <div class="col-12">
                <button type="submit" name="submit" class="btn btn-success d-block">save</button>
            </div>
        </form>
    </main>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e){
            ...
            if(validate == true){
                ...
                fetch('http://mavisa.com/Api/insert', {
                    method : 'POST',
                    headers : {
                ...
                .then(nom => sessionStorage.setItem("nom", data.nom))
                .then(prenom => sessionStorage.setItem("prenom", data.prenom))
                .then(x => console.log(sessionStorage.getItem("token", data.token)))
            }
